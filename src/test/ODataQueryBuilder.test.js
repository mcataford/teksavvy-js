...
import { UnsupportedOperatorError } from '../Exceptions'
...
describe('ODataQueryBuilder', () => {
    ...
    it('an invalid operator throws an UnsupportedOperatorError', () => {
        ...
        expect(() => queryBuilder.compose(malformedOperator)).toThrow(
    ...
    describe('TOP', () => {
        ...
        it('a zero or negative value throws a RangeError', () => {
            ...
            expect(() => queryBuilder.compose(malformedOperatorObj)).toThrow(
                RangeError,
            )
        })
    })
