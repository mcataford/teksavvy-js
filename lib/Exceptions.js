...
exports.MalformedFilterParameters = exports.InvalidKeyError = exports.UnsupportedComparatorError = exports.UnsupportedOperatorError = exports.MissingAPIKeyError = exports.RateLimitExceededError = undefined;
...
function _extendableBuiltin11(cls) {
...
var MalformedFilterParameters = exports.MalformedFilterParameters = function (_extendableBuiltin12) {
  (0, _inherits3.default)(MalformedFilterParameters, _extendableBuiltin12);

  function MalformedFilterParameters(message) {
    (0, _classCallCheck3.default)(this, MalformedFilterParameters);

    var _this6 = (0, _possibleConstructorReturn3.default)(this, (MalformedFilterParameters.__proto__ || (0, _getPrototypeOf2.default)(MalformedFilterParameters)).call(this, message));

    _this6.name = 'MalformedFilterParameters';
    return _this6;
  }

  return MalformedFilterParameters;
}(_extendableBuiltin11(Error));