...
var TeksavvyAPIWrapper = function TeksavvyAPIWrapper(apiKey) {
  ...
  this._buildOperatorParam = function (operatorObj) {
    var operator = operatorObj.name;

    if (operator === _constants2.default.operatorIdentifiers.TOP) {
      return (0, _defineProperty3.default)({}, _constants2.default.operators.TOP, operatorObj.value);
    }
  };
  ...
  this.usageRecords = function () {
    ...
    return _axios2.default.get(url, { headers: headers }).then(function (response) {
  ...
  this.usageSummaries = function () {
    ...
    var headers = _this._getDefaultHeaders();
    var requestTime = Date.now();
    var params = operator ? _this._buildOperatorParam(operator) : null;
